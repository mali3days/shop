      ...
      <b-tab title="<i class='icon-list'></i>">
        ...
        <Callout variant="warning" class="m-0 py-3">
          <div class="avatar float-right">
            <img src="../assets/images/static/avatars/7.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
          </div>
        ...
        <Callout variant="info" class="m-0 py-3">
          <div class="avatar float-right">
            <img src="../assets/images/static/avatars/4.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
          </div>
        ...
        <Callout variant="danger" class="m-0 py-3">
          ...
          <div class="avatars-stack mt-2">
            <div class="avatar avatar-xs">
              <img src="../assets/images/static/avatars/2.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
            </div>
            <div class="avatar avatar-xs">
              <img src="../assets/images/static/avatars/3.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
            </div>
            <div class="avatar avatar-xs">
              <img src="../assets/images/static/avatars/4.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
            </div>
            <div class="avatar avatar-xs">
              <img src="../assets/images/static/avatars/5.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
            </div>
            <div class="avatar avatar-xs">
              <img src="../assets/images/static/avatars/6.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
            </div>
          </div>
        </Callout>
        <hr class="mx-3 my-0">
        ...
        <Callout variant="primary" class="m-0 py-3">
          ...
          <div class="avatars-stack mt-2">
            ...
            <div class="avatar avatar-xs">
              <img src="../assets/images/static/avatars/8.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
            </div>
          </div>
        </Callout>
        <hr class="mx-3 my-0">
